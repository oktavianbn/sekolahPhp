...
<head>
    ...
    <title>AdminLTE 4 | Tables Agama</title>
    ...
    <meta name="title" content="AdminLTE 4 | Tables Agama" />
                                    ...
                                    <table id="tabelAgama" class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center whitespace-nowrap">Opsi</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            ?>
                                                <tr class="text-gray-700 text-center odd:bg-gray-50 even:bg-gray-200">
                                                    ...
                                                    <td class="p-3 border"><?php echo $a['id_agama']; ?></td>
                                                    <td class="p-3 border"><?php echo $a['nama_agama']; ?></td>
                                                    <td class="p-3 border">
                                                        <a href="edit.agama.php?id=<?php echo $a['id_agama']; ?>&aksi=edit" class="text-blue-600 hover:underline">Edit</a> |
                                                        <a href="proses.agama.php?id=<?php echo $a['id_agama']; ?>&aksi=hapus" class="text-red-600 hover:underline">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
